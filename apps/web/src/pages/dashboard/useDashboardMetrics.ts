...
export function useDashboardMetrics(): DashboardMetrics {
  ...
  return useMemo<DashboardMetrics>(() => {
     ...
     */
    /*
     * Выпуск 2.0.2 (заказчик, 17.09): «загрузка парка аренды считается за
     * вычетом скутеров в разборке». Разборка — техника на запчасти, в аренду
     * она уже не вернётся, а в знаменателе занижала процент. Ремонт и ДТП
     * остаются: они короткие (правка 31.08 ниже).
     */
     ...
     * арендного режима, включая ремонт и ДТП, а не только свободная к
     * выдаче. Разборку с 2.0.2 не считаем (см. RENTAL_MODE_STATUSES).
     *

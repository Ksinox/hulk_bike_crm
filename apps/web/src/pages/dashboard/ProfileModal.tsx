...
export function ProfileModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div
      className="fixed inset-0 z-[100] flex items-start justify-center overflow-y-auto overflow-x-hidden bg-ink/55 p-0 backdrop-blur-sm sm:p-6"
    >
      <div
        className="flex min-h-[100dvh] w-full flex-col overflow-hidden bg-surface shadow-card-lg sm:block sm:min-h-0 sm:mt-16 sm:max-w-[460px] sm:rounded-2xl"

      ...
      {newRentalOpen && (
        <NewRentalModal
          ...
          onCreated={(r) => {
            ...
            // v0.9: сначала закрываем всё ранее открытое в drawer-стеке —
            // иначе новая аренда «наслаивалась» поверх прежней карточки
            // (несколько карточек криво в ряд). Открываем ТОЛЬКО новую —
            // замена, а не стопка («принцип одного экрана»).
            drawer.close();

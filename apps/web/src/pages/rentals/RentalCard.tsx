  ...
  const body = (
    <>
      ...
      */}
      ...
      {/* C2: большой красный баннер «Долг по ущербу» убран. Долг (текущей
          аренды + сквозной с прошлых) теперь в KPI «Долг» — сумма со
          звёздочкой при наличии сквозного + раскрытие состава в поповере.
          Погашение — в «Принять платёж». */}
      ...
      {/* C2: F3-баннер «Долг клиента по другим арендам» и плашка «Клиент
          гасит ущерб» убраны — сквозной долг теперь в KPI «Долг» (со
          звёздочкой) и строкой в «Финансовой информации» (с переходом в
          аренду-источник); погашение — в «Принять платёж». Не сдвигаем
          контент карточки. */}

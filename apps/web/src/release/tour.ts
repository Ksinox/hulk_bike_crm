...
const RELEASE_2_0_4: ReleaseTourConfig = {
  ...
  items: [
    ...
    },
    {
      ...
      points: [
        "До 33% красный, до 50 оранжевый, от 50 жёлтый, от 90 зелёный",
    ...
    },
    {
      id: "mobile-parity",
      kind: "changed",
      title: "Ремонт с телефона",
      route: "service",
      headline: "Отметки, заметки, фото и «Готов к аренде» — теперь с телефона, а не «на компьютере».",
      why: "Механик у стойки не мог отметить работу: карточка ремонта на телефоне была только для чтения.",
      points: [
        "Отметка пункта — кнопка под палец, рядом заметка «что сделано»",
        "Фото с камеры прямо в пункт чек-листа",
        "Планшет: суммы вводит родная клавиатура",
      ],
      audience: "all",
      devices: ["phone"],

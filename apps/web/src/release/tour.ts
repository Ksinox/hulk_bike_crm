...
const RELEASE_2_0_4: ReleaseTourConfig = {
  ...
  items: [
    ...
    },
    {
      ...
      points: [
        "Ремонт: отметки, заметка «что сделано», фото с камеры, «Готов к аренде»",
        "Должники: дело с заметками, звонками и платежами",
        "Документы, прейскурант, модели, экипировка и архив",
      ],
      audience: "all",
      devices: ["phone"],

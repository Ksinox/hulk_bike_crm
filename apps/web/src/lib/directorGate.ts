...
> = {
  ...
  // 06.09 (п.11): прибыль и закуп в «Продажах» — только директору.
  sales_profit_reveal: {
    title: "Показать прибыль и закупочную стоимость",
    generic: "Цифры прибыли и закупа станут видны в этом окне браузера.",
  },

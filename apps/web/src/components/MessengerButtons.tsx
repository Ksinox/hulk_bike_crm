 ...
 *
 * ВАЖНО (баг найден 01.09): раньше здесь стоял флаг "noopener" — и имя
 * вкладки просто игнорировалось. Проверено вживую: два клика с noopener
 * открывают ДВЕ вкладки, без него — одну и ту же. То есть обещание «одна
 * вкладка на мессенджер» не работало ни для WhatsApp, ни для Telegram,
 * ни для MAX: каждый клик плодил новую.
 *
 * Защиту от доступа к нашей странице сохраняем вручную — обнуляем opener
 * сразу после открытия (это разрешено и для чужого домена).
 */

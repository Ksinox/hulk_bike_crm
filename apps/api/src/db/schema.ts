...
export const rentals = pgTable(
  "rentals",
  {
    ...
    /**
     * v0.9.8: аренда создана по ПРОИЗВОЛЬНОМУ («своему») тарифу — оператор
     * ввёл ставку вручную, не по стандартной сетке модели. Для бейджа
     * «свой тариф» в составе аренды (история + детализация выручки).
     */
    customTariff: boolean("custom_tariff").notNull().default(false),
    /**

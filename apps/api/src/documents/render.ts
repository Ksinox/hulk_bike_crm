...
<div class="wrap">
  ...
  <p class="cl"><b>4.1.</b>Стороны, подписав настоящий Договор, соглашаются, что стоимость Скутера, предоставленного в прокат, оценивается на основании его рыночной стоимости и составляет: ${fmtMoney(scooter?.purchasePrice ?? 0)} (${moneyWords(scooter?.purchasePrice ?? 0)}) рублей 00 копеек.</p>

...
<div class="wrap">
  ...
  <ol>
    <li>Арендодатель предоставляет Арендатору во временное владение и пользование за обусловленную настоящим Договором плату, транспортное средство, именуемое (далее — «Скутер»), характеристики которого указанное в Приложении № 1 к настоящему Договору.</li>
    <li>Арендодатель предоставляет Арендатору Скутер в исправном состоянии и без повреждений внешних частей корпуса по Акту приёма-передачи (Приложение № 1 к настоящему Договору). Акт приёма-передачи является неотъемлемой частью настоящего Договора.</li>
  ...
  <div class="para"><b>2.1. Арендодатель обязан:</b> Предоставить во временное владение и пользование Арендатору транспортное средство, указанное в п. 1.2. настоящего Договора, в технически исправном состоянии согласно и на условиях, указанных п. 1.3. настоящего Договора.</div>
  ...
  <ol>
    ...
    <li>Нести дополнительные расходы, связанные с эксплуатацией Скутера, в том числе расходы на ГСМ, расходы по компенсации вреда, причинённого жизни и здоровью, имуществу третьих лиц, возникшего в результате дорожно-транспортного происшествия по вине Арендатора и/или при нарушении правил дорожного движения Арендатором (оплата штрафов, штрафстоянок, услуги эвакуатора и иные расходы, повлекшие за собой невыполнение условий данного договора).</li>
    <li>Самостоятельно и в установленные сроки оплачивать штрафы за нарушение правил дорожного движения во время нахождения Скутера во владении и пользовании Арендатора.</li>
    <li>Не передавать Скутер в пользование и владение третьих лиц.</li>
    <li>Содержать Скутер в полной технической исправности.</li>
    <li>Возместить Арендодателю стоимость ремонта Скутера (его деталей) в полном объёме. Компенсировать Арендодателю расходы на доставку повреждённого Скутера. При этом Арендатор, подписав настоящий Договор, соглашается, что ремонт Скутера может быть произведён только самостоятельно Арендодателем либо Третьими лицами, привлечёнными Арендодателем.</li>
    <li>Хранить Скутер в местах, позволяющих обеспечить его надлежащее хранение, предотвращающее его порчу (охраняемая стоянка, гаражи, боксы и т.п.).</li>
    <li>В случае утраты Скутера, находящегося во владении и пользовании Арендатора, Арендатор обязуется компенсировать Арендодателю стоимость Скутера, установленную п. 4.1. настоящего Договора.</li>
    <li>В случае утраты деталей Скутера, находящегося во владении и пользовании Арендатора, Арендатор обязуется оплатить стоимость утраченной детали в полном объёме.</li>
    <li>В случае утраты документов на Скутер Арендатор обязуется оплатить Арендодателю расходы на восстановление документов в размере 1 500 (одна тысяча пятьсот) рублей 00 копеек.</li>
    <li>В случаях, указанных в п. 2.3.9.–2.3.11., Арендатор также обязан компенсировать Арендодателю упущенную выгоду в сумме ежедневного тарифа (согласно пункту 3.3) за каждый день простоя Скутера за всё время, необходимое для устранения причины простоя, ремонта деталей, их доставки и установки.</li>
    <li>Обязанности по компенсации ущерба и расходов Арендодателя, указанные в п. 2.3.9.–2.3.11., возникают в том числе, если в момент ДТП или утери Скутера/его деталей Арендатор находился в состоянии алкогольного, наркотического или иного опьянения.</li>
    <li>По истечении срока проката передать Скутер Арендодателю в состоянии, в котором он был получен по Акту приёма-передачи (возврата) (Приложение № 2 к настоящему Договору). При наличии загрязнений кузова Скутера Арендатор обязуется оплатить чистку (мойку) Скутера в размере 150,00 (сто пятьдесят) рублей 00 копеек.</li>
    <li>При возврате Скутера Арендатор обязан подписать Акт приёма-передачи (возврата) (Приложение № 2 к настоящему Договору). При наличии повреждений Скутера, причинённых Арендатором или Третьими лицами во время владения и пользования Скутером Арендатором, в Акте приёма-передачи (возврата) отражаются причинённые Скутеру (деталям Скутера) повреждения, а также размер компенсации и сроки оплаты компенсации Арендатором.</li>
    <li>В случае немотивированного отказа Арендатора от подписания Акта приёма-передачи (возврата) (Приложение № 2 к настоящему Договору) на условиях, указанных в п. 2.3.15. настоящего Договора, а равно немотивированного отказа Арендатора от указания в акте приёма-передачи (возврата) повреждений, размера компенсации и сроков оплаты компенсации, Акт приёма-передачи (возврата) составляется Арендодателем в присутствии двух представителей общественности, о чём в Акте делается соответствующая отметка и подписи указанных в нём лиц (данных).</li>
    <li>Арендатор не вправе наносить логотипы, размещать любого рода надписи, маркировать, изменять, скрывать фирменное брендирование или иным способом изменять внешний облик или читаемость информации, нанесённой на скутере Арендодателем; за порчу брендирования с Арендатора взимается оплата за восстановление первоначального вида брендирования в размере 3 000 (три тысячи) рублей за один элемент (одну сторону) брендирования.</li>
  </ol>

  <div class="para"><b>2.4. Арендатор не вправе:</b></div>
  <ol>
    <li><b>Передавать Скутер в субаренду.</b></li>
    <li>Предоставлять Скутер в безвозмездное пользование третьим лицам.</li>
    <li>Передавать Скутер в залог и вносить Скутер в качестве имущественного вклада в хозяйственные товарищества и общества или паевого взноса в производственные кооперативы, или обременять любым иным образом.</li>
    <li>Управлять транспортным средством в состоянии наркотического, алкогольного, токсического опьянения.</li>
    <li>Нарушать внешний вид, заменять, демонтировать, подменять, ремонтировать детали, узлы и агрегаты без согласования с Арендодателем.</li>
  </ol>

  <h2>3. Арендная плата, порядок и сроки расчётов</h2>
  <ol>
    <li>Скутер предоставляется Арендатору в прокат (аренду) посуточно. Стороны соглашаются, что одни сутки — это ровно 24 часа.
      <ol>
  ...
  <ol start="3">
    <li>Арендная плата Скутера за время действия аренды составляет <b>${fmtMoney(rental.sum)} (${moneyWords(rental.sum)}) рублей</b> и производится Арендатором наличными платежами либо на банковские реквизиты, указанные Арендодателем, либо наличными в рублях.</li>
    <li>Стороны установили, что плату за аренду Скутера Арендатор производит в день получения Скутера, на условиях, указанных в п. 3.1.1, 3.1.2 и 3.3. настоящего Договора.</li>
    <li>В случае невозврата Арендатором арендованного Скутера в установленные настоящим Договором сроки и не заключении нового договора аренды, в отношении Арендатора наступает ответственность, предусмотренная Уголовным кодексом Российской Федерации, и действия Арендатора в таком случае квалифицируются как незаконное завладение транспортным средством (угон).</li>
  </ol>

  <h2>4. Цена имущества</h2>
  <ol>
    <li>Стороны, подписав настоящий Договор, соглашаются, что стоимость Скутера, предоставленного в прокат, оценивается на основании его рыночной стоимости и составляет: ${fmtMoney(scooter?.purchasePrice ?? 0)} (${moneyWords(scooter?.purchasePrice ?? 0)}) рублей 00 копеек.</li>
    <li>Подписав настоящий Договор, Арендатор выражает согласие компенсировать стоимость утраченных/повреждённых комплектующих Скутера (деталей Скутера) в полном объёме.</li>
    <li>Если настоящим Договором не предусмотрено иное, Стороны договариваются о возмещении ущерба исходя из цен на запасные части, работы и услуги согласно рыночной стоимости.</li>
  </ol>

  <h2>5. Ответственность сторон</h2>
  <div class="para"><b>5.1. Арендатор несёт ответственность:</b></div>
  <ol>
    <li>В случае нецелевого использования Скутера, полученного по настоящему Договору, Арендатор уплачивает Арендодателю компенсацию в размере 1 000,00 (одна тысяча) рублей 00 копеек.</li>
    <li>В случае нанесения повреждений Скутеру, а равно фирменному брендированию, из суммы, указанной в п. 1.5. залога, удерживается стоимость ремонта. В случае если стоимость ремонта превышает размер залога, Арендатор обязан возместить Арендодателю денежную сумму, превышающую размер залога, исходя из рыночной стоимости при возврате Скутера Арендодателю.</li>
  ...
  <ol start="2">
    ...
    <li>В случае неисполнения Арендатором обязанности по компенсации ущерба, причинённого им Скутеру, при возврате Скутера Арендодателю с Арендатора подлежит взысканию (кроме суммы ущерба) компенсация в размере 1 000,00 (одна тысяча) рублей 00 копеек за каждый день до момента полной компенсации причинённого ущерба (оплаты ремонта).</li>
  ...
  <ol>
    <li>Настоящий договор вступает в силу с даты подписания и действует до исполнения Сторонами всех принятых на себя обязательств в рамках данного Договора, а также до момента подписания Арендатором акта приёма-передачи (возврата), указанного в п. 2.3.15. настоящего Договора.</li>
    <li>По истечении срока действия настоящего договора Арендатор не имеет преимущественного права на заключение договора проката данного Скутера на новый срок.</li>
    <li>По требованию Арендодателя настоящий договор может быть досрочно расторгнут в случаях, когда Арендатор:
      <ol>
        <li>Использует Скутер не в соответствии с настоящим договором или целевым назначением.</li>
        <li>Не выполняет обязанностей по содержанию Скутера в надлежащем состоянии.</li>
        <li>Существенно ухудшает состояние Скутера.</li>
        <li>Не внёс предоплату или задержал оплату за указанный период в п. 3.1.2., 3.1.3 настоящего договора.</li>
      </ol>
    </li>
    <li>По желанию Арендатора договор может быть досрочно расторгнут, при этом сумма, уплаченная за весь срок аренды по данному договору, возврату не подлежит.</li>
  </ol>

  <h2>7. Порядок возврата Скутера</h2>
  <ol>
    <li>По истечении срока проката транспортного средства Арендатор обязан незамедлительно передать Арендодателю имущество по акту приёма-передачи (возврата) на условиях, указанных в п. 2.3.15. настоящего Договора.</li>
    <li>Скутер должен быть возвращён Арендодателю в том состоянии, в котором Арендатор его получил.</li>
    <li>Скутер может быть возвращён до окончания срока, указанного в пункте 3.1.2. настоящего договора, только при условии уведомления Арендодателя не менее чем за сутки. При этом стоимость арендной платы, указанная в п. 3.3. настоящего Договора, возврату не подлежит.</li>
  </ol>

  <h2>8. Заключительные положения</h2>
  <ol>
    <li>Все изменения и дополнения к настоящему договору считаются действительными, если они составлены в письменной форме и подписаны Сторонами.</li>
    <li>Настоящий договор подписан в двух экземплярах, имеющих одинаковую юридическую силу — по одному для каждой из Сторон.</li>
    <li>Все споры и разногласия, которые могут возникнуть из настоящего договора или в связи с ним, будут, по возможности, решаться путём переговоров между Сторонами.</li>
    <li>При недостижении согласия споры между Сторонами, связанные с настоящим договором, в соответствии с ч. 9 ст. 29 ГПК РФ подлежат рассмотрению в Центральном районном суде г. Краснодара, по адресу: Ставропольская, 75/1, т.е. по месту исполнения настоящего Договора.</li>
    <li>Подписывая Договор аренды, Арендатор тем самым подтверждает, что физически и психически готов к заезду на Скутере, проинструктирован о правилах пользования Скутером, обязуется соблюдать все правила и использовать Скутер только в целях, для которых он предназначен, осведомлён о существовании риска для себя и других участников заездов, а также третьих лиц, осознаёт, что несоблюдение правил может привести к получению травм различной степени и отрицательно сказаться на его здоровье, отказывается от каких-либо материальных или иных претензий и требований к Арендодателю, владельцам Скутера, арендует Скутер под свою ответственность и берёт на себя ответственность за детей.</li>
    <li>Арендатор обязуется не выезжать на Скутере за пределы г. Краснодара не далее 30 км от его границы.</li>
    <li>Залог или залоговое имущество возвращается Арендатору после осмотра и принятия Скутера и аксессуаров по акту приёма-передачи (возврата) на условиях, указанных в п. 2.3.15 настоящего Договора.</li>
    <li>Подписывая настоящий Договор, Арендатор даёт своё добровольное согласие Арендодателю на обработку своих персональных данных и передачу Арендодателем этих персональных данных третьим лицам.</li>
  </ol>

...
<div class="top-actions no-print">
  <div>Предпросмотр — распечатайте или сохраните как PDF через диалог печати браузера.</div>
...
<div class="wrap">
  ...
  <ol>
    <li>В случае нецелевого использования Скутера Арендатор уплачивает 1 000 рублей.</li>
    <li>В случае нанесения повреждений Скутеру стоимость ремонта удерживается из залога. Если превышает размер залога — Арендатор возмещает разницу.</li>
    <li>В случае причинения вреда третьим лицам ответственность перед ними несёт Арендатор.</li>
    <li>В случае гибели, хищения или причинения вреда Скутеру Арендатор возмещает все расходы.</li>
    <li>Арендатор несёт ответственность в объёме, указанном в Договоре, а также за счёт залога.</li>
  </ol>

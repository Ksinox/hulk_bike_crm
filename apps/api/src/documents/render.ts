...
<style>
  ...
  h2 { font-size: 12pt; text-align: center; font-weight: bold; margin: 12pt 0 6pt; page-break-after: avoid; }
  ...
  /* Нумерованные пункты договора (как в оригинале Сахаров.md в Word):
   * номер жирным в начале строки, после него небольшой фиксированный
   * пробел через margin-right на <b>, дальше обычный текст с justify.
   * Перенос строк — БЕЗ hanging indent: следующая строка начинается
   * с левого края параграфа, выравниваясь с номером (как в Word'е).
   *
   * .cl  — пункт уровня X.Y (1.1, 2.3, 6.4, ...)
   * .cl2 — пункт уровня X.Y.Z (2.3.17, 6.3.1, 5.1.3, ...)
   *
   * margin-right на <b> вместо обычного пробела между </b> и текстом
   * нужен потому что text-align: justify растягивает обычные пробелы,
   * а margin он не трогает — номер и текст всегда отделены ровно 8pt.
   */
  p.cl, p.cl2 {
    margin: 3pt 0;
    text-align: justify;
...
function tplContract(b: Bundle): string {
  ...
  const depositLine =
    rental.depositItem && rental.deposit === 0
      ...
      : `денежных средств в размере ${fmtMoney(depositAmount, false)} (${moneyWords(depositAmount)}) рублей 00 копеек`;
...
<div class="wrap">
  ...
  <p class="cl"><b>1.1.</b>Арендодатель предоставляет Арендатору во временное владение и пользование за обусловленную настоящим Договором плату, транспортное средство, именуемое (далее — «Скутер»), характеристики которого указанное в Приложении № 1 к настоящему Договору.</p>
  <p class="cl"><b>1.2.</b>Арендодатель предоставляет Арендатору Скутер в исправном состоянии и без повреждений внешних частей корпуса по Акту приёма-передачи (Приложение № 1 к настоящему Договору). Акт приёма-передачи является неотъемлемой частью настоящего Договора.</p>
  <p class="cl"><b>1.3.</b>Арендатор, подписав Акт приёма-передачи, подтверждает, что Скутер в исправном состоянии и соответствует условиям договора.</p>
  <p class="cl"><b>1.4.</b>Скутер передаётся Арендатору на срок, указанный в п. 3.1. настоящего Договора.</p>
  <p class="cl"><b>1.5.</b>Стороны согласовали, что Скутер (категории М, А1, А, В) передаётся в прокат под залог ${depositLine}.</p>

  <h2>2. Права и обязанности сторон</h2>
  <p class="subhead"><b>2.1. Арендодатель обязан:</b></p>
  <p class="cl2"><b>2.1.1.</b>Предоставить во временное владение и пользование Арендатору транспортное средство, указанное в п. 1.2. настоящего Договора, в технически исправном состоянии согласно и на условиях, указанных п. 1.3. настоящего Договора.</p>

  <p class="subhead"><b>2.2. Арендодатель вправе:</b></p>
  <p class="cl2"><b>2.2.1.</b>Расторгнуть настоящий Договор в одностороннем порядке и потребовать возврата Скутера в случае, если Арендатор нарушает правила эксплуатации Скутера и/или условия Договора.</p>
  <p class="cl2"><b>2.2.2.</b>Отказать Арендатору в продлении срока действия настоящего Договора.</p>
  <p class="cl2"><b>2.2.3.</b>Арендодатель подтверждает, что имущество не является предметом залога и не обременено иными правами третьих лиц.</p>

  <p class="subhead"><b>2.3. Арендатор обязан:</b></p>
  <p class="cl2"><b>2.3.1.</b>Использовать Скутер в соответствии с его целевым назначением без права использования в коммерческих целях, проявляя должную осмотрительность и бережность.</p>
  <p class="cl2"><b>2.3.2.</b>Уплачивать Арендодателю арендную плату в размере, сроки и порядке, предусмотренные пунктом 3.1–3.4 настоящего Договора.</p>
  <p class="cl2"><b>2.3.3.</b>Нести дополнительные расходы, связанные с эксплуатацией Скутера, в том числе расходы на ГСМ, расходы по компенсации вреда, причинённого жизни и здоровью, имуществу третьих лиц, возникшего в результате дорожно-транспортного происшествия по вине Арендатора и/или при нарушении правил дорожного движения Арендатором (оплата штрафов, штрафстоянок, услуги эвакуатора и иные расходы, повлекшие за собой невыполнение условий данного договора).</p>
  <p class="cl2"><b>2.3.4.</b>Самостоятельно и в установленные сроки оплачивать штрафы за нарушение правил дорожного движения во время нахождения Скутера во владении и пользовании Арендатора.</p>
  <p class="cl2"><b>2.3.5.</b>Не передавать Скутер в пользование и владение третьих лиц.</p>
  <p class="cl2"><b>2.3.6.</b>Содержать Скутер в полной технической исправности.</p>
  <p class="cl2"><b>2.3.7.</b>Возместить Арендодателю стоимость ремонта Скутера (его деталей) в полном объёме. Компенсировать Арендодателю расходы на доставку повреждённого Скутера. При этом Арендатор, подписав настоящий Договор, соглашается, что ремонт Скутера может быть произведён только самостоятельно Арендодателем либо Третьими лицами, привлечёнными Арендодателем.</p>
  <p class="cl2"><b>2.3.8.</b>Хранить Скутер в местах, позволяющих обеспечить его надлежащее хранение, предотвращающее его порчу (охраняемая стоянка, гаражи, боксы и т.п.).</p>
  <p class="cl2"><b>2.3.9.</b>В случае утраты Скутера, находящегося во владении и пользовании Арендатора, Арендатор обязуется компенсировать Арендодателю стоимость Скутера, установленную п. 4.1. настоящего Договора.</p>
  <p class="cl2"><b>2.3.10.</b>В случае утраты деталей Скутера, находящегося во владении и пользовании Арендатора, Арендатор обязуется оплатить стоимость утраченной детали в полном объёме.</p>
  <p class="cl2"><b>2.3.11.</b>В случае утраты документов на Скутер Арендатор обязуется оплатить Арендодателю расходы на восстановление документов в размере 1 500 (одна тысяча пятьсот) рублей 00 копеек.</p>
  <p class="cl2"><b>2.3.12.</b>В случаях, указанных в п. 2.3.9.–2.3.11., Арендатор также обязан компенсировать Арендодателю упущенную выгоду в сумме ежедневного тарифа (согласно пункту 3.3) за каждый день простоя Скутера за всё время, необходимое для устранения причины простоя, ремонта деталей, их доставки и установки.</p>
  <p class="cl2"><b>2.3.13.</b>Обязанности по компенсации ущерба и расходов Арендодателя, указанные в п. 2.3.9.–2.3.11., возникают в том числе, если в момент ДТП или утери Скутера/его деталей Арендатор находился в состоянии алкогольного, наркотического или иного опьянения.</p>
  <p class="cl2"><b>2.3.14.</b>По истечении срока проката передать Скутер Арендодателю в состоянии, в котором он был получен по Акту приёма-передачи (возврата) (Приложение № 2 к настоящему Договору). При наличии загрязнений кузова Скутера Арендатор обязуется оплатить чистку (мойку) Скутера в размере 150,00 (сто пятьдесят) рублей 00 копеек.</p>
  <p class="cl2"><b>2.3.15.</b>При возврате Скутера Арендатор обязан подписать Акт приёма-передачи (возврата) (Приложение № 2 к настоящему Договору). При наличии повреждений Скутера, причинённых Арендатором или Третьими лицами во время владения и пользования Скутером Арендатором, в Акте приёма-передачи (возврата) отражаются причинённые Скутеру (деталям Скутера) повреждения, а также размер компенсации и сроки оплаты компенсации Арендатором.</p>
  <p class="cl2"><b>2.3.16.</b>В случае немотивированного отказа Арендатора от подписания Акта приёма-передачи (возврата) (Приложение № 2 к настоящему Договору) на условиях, указанных в п. 2.3.15. настоящего Договора, а равно немотивированного отказа Арендатора от указания в акте приёма-передачи (возврата) повреждений, размера компенсации и сроков оплаты компенсации, Акт приёма-передачи (возврата) составляется Арендодателем в присутствии двух представителей общественности, о чём в Акте делается соответствующая отметка и подписи указанных в нём лиц (данных).</p>
  <p class="cl2"><b>2.3.17.</b>Арендатор не вправе наносить логотипы, размещать любого рода надписи, маркировать, изменять, скрывать фирменное брендирование или иным способом изменять внешний облик или читаемость информации, нанесённой на скутере Арендодателем; за порчу брендирования с Арендатора взимается оплата за восстановление первоначального вида брендирования в размере 3 000 (три тысячи) рублей за один элемент (одну сторону) брендирования.</p>

  <p class="subhead"><b>2.4. Арендатор не вправе:</b></p>
  <p class="cl2"><b>2.4.1.</b><b>Передавать Скутер в субаренду.</b></p>
  <p class="cl2"><b>2.4.2.</b>Предоставлять Скутер в безвозмездное пользование третьим лицам.</p>
  <p class="cl2"><b>2.4.3.</b>Передавать Скутер в залог и вносить Скутер в качестве имущественного вклада в хозяйственные товарищества и общества или паевого взноса в производственные кооперативы, или обременять любым иным образом.</p>
  <p class="cl2"><b>2.4.4.</b>Управлять транспортным средством в состоянии наркотического, алкогольного, токсического опьянения.</p>
  <p class="cl2"><b>2.4.5.</b>Нарушать внешний вид, заменять, демонтировать, подменять, ремонтировать детали, узлы и агрегаты без согласования с Арендодателем.</p>

  <h2>3. Арендная плата, порядок и сроки расчётов</h2>
  <p class="cl"><b>3.1.</b>Скутер предоставляется Арендатору в прокат (аренду) посуточно. Стороны соглашаются, что одни сутки — это ровно 24 часа.</p>
  <p class="cl2"><b>3.1.1.</b>Скутер выдан: ${fmtDateShort(rental.startAt)} в <b>${fmtTimeMsk(rental.startAt)}</b></p>
  <p class="cl2"><b>3.1.2.</b>Срок возврата Скутера: ${fmtDateShort(rental.endPlannedAt)} в <b>${fmtTimeMsk(rental.endPlannedAt)}</b></p>

  <div class="para keep-together">
    <b>Настоящий договор предусматривает типы оплат:</b>
    <div style="margin: 4pt 0 6pt 0">${checkbox(true)} Полная предоплата (за весь период аренды, указанный в п. 3.1.1–3.1.2)</div>
    <div style="margin: 0 0 6pt 0">${checkbox(false)} Еженедельная рассрочка, предоплата за грядущую неделю оплачивается до 15:00 по Московскому времени, в сумме <b>${fmtMoney(weeklyAmount, false)}</b> рублей.</div>
    <div class="para small">
      По истечении времени оплаты в указанный период Арендодатель вправе в одностороннем порядке расторгнуть договор и потребовать вернуть транспортное средство на место получения в течение одного часа (60 минут). При несвоевременном внесении в срок очередной платы за аренду Арендатор уплачивает Арендодателю арендную плату и неустойку в размере 50 % (пятидесяти процентов) от суточной арендной платы за каждый день просрочки. При отказе возврата Скутера Арендатор оплачивает забор Скутера в размере суммы, указанной в п. 1.5. настоящего Договора; санкции за превышение времени возврата Скутера более чем на 60 минут будут остановлены после подписания акта приёма-передачи (Приложение № 2) настоящего договора.
    </div>
  </div>

  <p class="cl"><b>3.2.</b>Время, указанное в п. 3.1.1–3.1.2., является расчётным. При возврате Скутера с превышением данного времени более чем на 60 минут или времени очередного платежа при рассрочке платежей, кроме арендной платы Арендатор обязан оплатить Арендодателю денежную компенсацию за просрочку возврата Скутера в размере половины суммы, указанной в п. 3.3. настоящего Договора. При возврате Скутера с превышением времени более чем на 120 минут Арендатор оплачивает Арендодателю денежную компенсацию в размере 300 (триста) рублей 00 копеек за каждые 60 минут просрочки вплоть до возврата Скутера Арендодателю.</p>

  <div class="para"><i>Аренда Скутера продлевается только при заключении нового Договора проката (аренды) Скутера и не может быть продлена по телефонному звонку с учётом вычета из залоговой суммы. В случае не заключения нового договора будут применены штрафные санкции согласно требованиям настоящего Договора.</i></div>

  <p class="cl"><b>3.3.</b>Арендная плата Скутера за время действия аренды составляет <b>${fmtMoney(rental.sum)} (${moneyWords(rental.sum)}) рублей</b> и производится Арендатором наличными платежами либо на банковские реквизиты, указанные Арендодателем, либо наличными в рублях.</p>
  <p class="cl"><b>3.4.</b>Стороны установили, что плату за аренду Скутера Арендатор производит в день получения Скутера, на условиях, указанных в п. 3.1.1, 3.1.2 и 3.3. настоящего Договора.</p>
  <p class="cl"><b>3.5.</b>В случае невозврата Арендатором арендованного Скутера в установленные настоящим Договором сроки и не заключении нового договора аренды, в отношении Арендатора наступает ответственность, предусмотренная Уголовным кодексом Российской Федерации, и действия Арендатора в таком случае квалифицируются как незаконное завладение транспортным средством (угон).</p>

  <h2>4. Цена имущества</h2>
  <p class="cl"><b>4.1.</b>Стороны, подписав настоящий Договор, соглашаются, что стоимость Скутера, предоставленного в прокат, оценивается на основании его рыночной стоимости и составляет: ${fmtMoney(scooter?.marketValue ?? scooter?.purchasePrice ?? 0)} (${moneyWords(scooter?.marketValue ?? scooter?.purchasePrice ?? 0)}) рублей 00 копеек.</p>
  <p class="cl"><b>4.2.</b>Подписав настоящий Договор, Арендатор выражает согласие компенсировать стоимость утраченных/повреждённых комплектующих Скутера (деталей Скутера) в полном объёме.</p>
  <p class="cl"><b>4.3.</b>Если настоящим Договором не предусмотрено иное, Стороны договариваются о возмещении ущерба исходя из цен на запасные части, работы и услуги согласно рыночной стоимости.</p>

  <h2>5. Ответственность сторон</h2>
  <p class="subhead"><b>5.1. Арендатор несёт ответственность:</b></p>
  <p class="cl2"><b>5.1.1.</b>В случае нецелевого использования Скутера, полученного по настоящему Договору, Арендатор уплачивает Арендодателю компенсацию в размере 1 000,00 (одна тысяча) рублей 00 копеек.</p>
  <p class="cl2"><b>5.1.2.</b>В случае нанесения повреждений Скутеру, а равно фирменному брендированию, из суммы, указанной в п. 1.5. залога, удерживается стоимость ремонта. В случае если стоимость ремонта превышает размер залога, Арендатор обязан возместить Арендодателю денежную сумму, превышающую размер залога, исходя из рыночной стоимости при возврате Скутера Арендодателю.</p>
  <p class="cl2"><b>5.1.3.</b>Арендатор обязуется вернуть Скутер Арендодателю в исправном состоянии по акту до истечения срока, указанного в п. 3.1.2. настоящего Договора, а в случае поломки/порчи/уничтожения Скутера Арендатор обязуется собственными силами и за счёт собственных средств доставить Скутер в пункт проката.</p>

  <p class="cl"><b>5.2.</b>В случае нарушения Арендатором условий договора, техники безопасности, повлекших за собой вред здоровью Арендатора, — Арендодатель ответственности не несёт.</p>
  <p class="cl"><b>5.3.</b>В случае причинения вреда Арендатором третьим лицам ответственность перед третьими лицами несёт Арендатор.</p>
  <p class="cl"><b>5.4.</b>В случае гибели, хищения или причинения вреда Скутеру Арендатор возмещает Арендодателю все расходы, связанные с причинением вреда или утратой Скутера.</p>
  <p class="cl"><b>5.5.</b>Арендатор несёт ответственность перед Арендодателем в объёме, указанном в настоящем Договоре, а также за счёт залога.</p>
  <p class="cl"><b>5.6.</b>В случае невозврата Арендатором арендованного Скутера в установленные настоящим договором сроки и не продлении настоящего договора в отношении Арендатора наступает ответственность, предусмотренная Уголовным кодексом Российской Федерации, и квалифицируется как незаконное завладение транспортным средством.</p>
  <p class="cl"><b>5.7.</b>В случае неисполнения Арендатором обязанности по компенсации ущерба, причинённого им Скутеру, при возврате Скутера Арендодателю с Арендатора подлежит взысканию (кроме суммы ущерба) компенсация в размере 1 000,00 (одна тысяча) рублей 00 копеек за каждый день до момента полной компенсации причинённого ущерба (оплаты ремонта).</p>
  <p class="cl"><b>5.8.</b>В случае, указанном в п. 2.3.16. настоящего договора, также наступают последствия, установленные п. 5.7. настоящего договора.</p>
  <p class="cl"><b>5.9.</b>Арендодатель также уведомляет Арендатора о том, что в случаях:</p>
  <ul style="margin: 4pt 0 4pt 44pt; padding: 0">
  ...
  <p style="padding-left: 44pt; margin: 4pt 0; text-align: justify">Арендодатель вправе обратиться за защитой нарушенных прав в судебном порядке. В результате чего с Арендатора кроме сумм задолженности по арендной плате, компенсации ущерба, штрафа (п. 5.7. настоящего договора) будут взысканы судебные расходы (оплата услуг представителей, государственная пошлина).</p>

  <h2>6. Срок действия договора</h2>
  <p class="cl"><b>6.1.</b>Настоящий договор вступает в силу с даты подписания и действует до исполнения Сторонами всех принятых на себя обязательств в рамках данного Договора, а также до момента подписания Арендатором акта приёма-передачи (возврата), указанного в п. 2.3.15. настоящего Договора.</p>
  <p class="cl"><b>6.2.</b>По истечении срока действия настоящего договора Арендатор не имеет преимущественного права на заключение договора проката данного Скутера на новый срок.</p>
  <p class="cl"><b>6.3.</b>По требованию Арендодателя настоящий договор может быть досрочно расторгнут в случаях, когда Арендатор:</p>
  <p class="cl2"><b>6.3.1.</b>Использует Скутер не в соответствии с настоящим договором или целевым назначением.</p>
  <p class="cl2"><b>6.3.2.</b>Не выполняет обязанностей по содержанию Скутера в надлежащем состоянии.</p>
  <p class="cl2"><b>6.3.3.</b>Существенно ухудшает состояние Скутера.</p>
  <p class="cl2"><b>6.3.4.</b>Не внёс предоплату или задержал оплату за указанный период в п. 3.1.2., 3.1.3 настоящего договора.</p>
  <p class="cl"><b>6.4.</b>По желанию Арендатора договор может быть досрочно расторгнут, при этом сумма, уплаченная за весь срок аренды по данному договору, возврату не подлежит.</p>

  <h2>7. Порядок возврата Скутера</h2>
  <p class="cl"><b>7.1.</b>По истечении срока проката транспортного средства Арендатор обязан незамедлительно передать Арендодателю имущество по акту приёма-передачи (возврата) на условиях, указанных в п. 2.3.15. настоящего Договора.</p>
  <p class="cl"><b>7.2.</b>Скутер должен быть возвращён Арендодателю в том состоянии, в котором Арендатор его получил.</p>
  <p class="cl"><b>7.3.</b>Скутер может быть возвращён до окончания срока, указанного в пункте 3.1.2. настоящего договора, только при условии уведомления Арендодателя не менее чем за сутки. При этом стоимость арендной платы, указанная в п. 3.3. настоящего Договора, возврату не подлежит.</p>

  <h2>8. Заключительные положения</h2>
  <p class="cl"><b>8.1.</b>Все изменения и дополнения к настоящему договору считаются действительными, если они составлены в письменной форме и подписаны Сторонами.</p>
  <p class="cl"><b>8.2.</b>Настоящий договор подписан в двух экземплярах, имеющих одинаковую юридическую силу — по одному для каждой из Сторон.</p>
  <p class="cl"><b>8.3.</b>Все споры и разногласия, которые могут возникнуть из настоящего договора или в связи с ним, будут, по возможности, решаться путём переговоров между Сторонами.</p>
  <p class="cl"><b>8.4.</b>При недостижении согласия споры между Сторонами, связанные с настоящим договором, в соответствии с ч. 9 ст. 29 ГПК РФ подлежат рассмотрению в Центральном районном суде г. Краснодара, по адресу: Ставропольская, 75/1, т.е. по месту исполнения настоящего Договора.</p>
  <p class="cl"><b>8.5.</b>Подписывая Договор аренды, Арендатор тем самым подтверждает, что физически и психически готов к заезду на Скутере, проинструктирован о правилах пользования Скутером, обязуется соблюдать все правила и использовать Скутер только в целях, для которых он предназначен, осведомлён о существовании риска для себя и других участников заездов, а также третьих лиц, осознаёт, что несоблюдение правил может привести к получению травм различной степени и отрицательно сказаться на его здоровье, отказывается от каких-либо материальных или иных претензий и требований к Арендодателю, владельцам Скутера, арендует Скутер под свою ответственность и берёт на себя ответственность за детей.</p>
  <p class="cl"><b>8.6.</b>Арендатор обязуется не выезжать на Скутере за пределы г. Краснодара не далее 30 км от его границы.</p>
  <p class="cl"><b>8.7.</b>Залог или залоговое имущество возвращается Арендатору после осмотра и принятия Скутера и аксессуаров по акту приёма-передачи (возврата) на условиях, указанных в п. 2.3.15 настоящего Договора.</p>
  <p class="cl"><b>8.8.</b>Подписывая настоящий Договор, Арендатор даёт своё добровольное согласие Арендодателю на обработку своих персональных данных и передачу Арендодателем этих персональных данных третьим лицам.</p>

...
<style>
  ...
  .money { margin-top: 14pt; page-break-inside: avoid; }
  .money-sig { display: flex; align-items: flex-end; gap: 10pt; margin-top: 4pt; }
  .money-sig .line { display: inline-block; width: 46%; border-bottom: 1px solid #000; height: 22pt; }
  .wrap { background: #fff; }
...
<div class="wrap">
  ...
  <div class="para"><b>4.1.</b> Продавец предоставляет гарантию на двигатель транспортного средства сроком <b>30 (тридцать) календарных дней</b> с момента передачи <b>или до пробега 1 000 (одна тысяча) километров</b> с момента передачи (показания одометра ${fmtMoney((deal.mileage ?? scooter?.mileage ?? 0) + 1000)} км) — в зависимости от того, какое из событий наступит раньше.</div>
  <div class="para"><b>4.2.</b> Гарантия распространяется исключительно на двигатель. Гарантия не распространяется на расходные материалы, электрооборудование, ходовую часть, элементы кузова и пластика, а также на неисправности, возникшие вследствие нарушения правил эксплуатации, ДТП, перегрева, использования некачественного топлива и масла, вмешательства третьих лиц или самостоятельного ремонта.</div>
  <div class="para"><b>4.3.</b> Гарантийные обязательства действуют при условии, что денежные средства в сумме, указанной в п. 2.1 настоящего договора, фактически переданы Покупателем Продавцу в полном объёме, что подтверждается подписью Покупателя в настоящем договоре.</div>

  <h2>5. Заключительные положения</h2>
  <div class="para"><b>5.1.</b> Настоящий договор составлен в двух экземплярах, имеющих равную юридическую силу, по одному для каждой из сторон.</div>
  <div class="para"><b>5.2.</b> Обязанность по постановке транспортного средства на регистрационный учёт возлагается на Покупателя.</div>
  <div class="para"><b>5.3.</b> Все споры разрешаются сторонами путём переговоров, а при недостижении согласия — в порядке, установленном законодательством РФ.</div>
  ...
  <div class="money">
    <div>Денежные средства в сумме <b>${fmtMoney(price)}</b> (${moneyWords(price)}) рублей 00 копеек передал:</div>
    <div class="small">(гарантийные обязательства по разделу 4 действуют только при условии, что указанная сумма соответствует фактически переданной)</div>
    <div class="money-sig"><span class="line"></span><span class="small">подпись Покупателя / ${escape(client?.name) || "____________________"}</span></div>
  </div>
  <div class="small" style="margin-top:10pt;">Денежные средства получил, транспортное средство передал: ______________ / ${escape(LANDLORD.fullName)}</div>
